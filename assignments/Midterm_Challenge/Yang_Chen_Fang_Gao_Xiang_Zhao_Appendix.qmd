...
crime_2023 <- read_csv(here("Midterm_Challenge/data/crime_2023.csv"), na = c("", "NA", "NaN", "NULL"), guess_max = 1e6)
crime_2024 <- read_csv(here("Midterm_Challenge/data/crime_2024.csv"), na = c("", "NA", "NaN", "NULL"), guess_max = 1e6)
...
opa_clean <- read_csv(here("Midterm_Challenge/data/opa_sales_2023_2024_residential_clean.csv"))
...
parks <- st_read(here("Midterm_Challenge/data/PPR_Program_Sites.geojson"), quiet = TRUE) %>%
  st_transform(2272)
...
transit_path <- here("Midterm_Challenge/data/Transit_Stops_(Spring_2025).geojson")
...
hospitals <- st_read(here("Midterm_Challenge/data/Hospitals.geojson"), quiet = TRUE) %>%
  st_transform(analysis_crs)
